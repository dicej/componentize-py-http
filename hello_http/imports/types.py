...
class Fields:
    ...
    def from_list(cls, entries: List[Tuple[str, bytes]]) -> Self:
        ...
        Raises: `hello_http.types.Err(hello_http.imports.types.HeaderError)`
        """
        raise NotImplementedError
...
class IncomingBody:
    ...
    def stream(self) -> streams.InputStream:
        ...
        Raises: `hello_http.types.Err(None)`
        """
        raise NotImplementedError
...
class OutgoingBody:
    ...
    def finish(cls, this: Self, trailers: Optional[Fields]) -> None:
        ...
        Raises: `hello_http.types.Err(hello_http.imports.types.ErrorCode)`
        """
        raise NotImplementedError
